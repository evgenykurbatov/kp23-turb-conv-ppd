...
#ax_.semilogx(f['z']/const.AU, -np.gradient(f['F_conv'], f['z']),
#             label=r"-$dF_\mathrm{conv}/dz$")
#ax_.semilogx(f['z']/const.AU, f['qturb'], label=r"$\rho S_\mathrm{turb}$")
