...
ax_.set_xscale('log')
ax_.set_ylim(ymin=1e-18, ymax=3.33e-10)
ax_.set_ylabel(r"g cm$^{-3}$")

ax_ = ax[0,1]
ax_.set_title(r"$T$", x=0.1, y=0.5)
...
ax_.set_ylim(ymin=1e9, ymax=1e11)
"""
ax_ = ax[1,0]
...
ax_.set_xscale('log')
#ax_.set_ylim(ymin=3.33e-16, ymax=1e-8)
ax_.set_ylim(ymin=3.33e-17, ymax=1e-8)
