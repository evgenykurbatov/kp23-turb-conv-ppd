...
## Length units
nm = 1e-7        ## 1e-9 meter [cm]
Angstrom = 1e-8  ## [cm]
## Energy units
Joile = 1e7      ## [erg]
Watt = 1e7       ## Joile/sec [erg/s]
EV = 1.6022e-12  ## Electron-Volt [erg]
eV = EV
## Force units
Newton = 1e5     ## kilogramm meter/sec^2 [g cm/s^2]
## Pressure units
Pascal = 10.0    ## Joile/meter^3 [erg/cm^3]
...
## In SI it equals to 1e-26 Watts/meter^2/Hz
